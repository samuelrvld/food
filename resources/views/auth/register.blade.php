...
<html lang="en">
   <head>
      ...
      <title>User Register Osahan Eat - Online Food Ordering</title>
      <!-- Favicon Icon -->
      ...
      <!-- Select2 CSS-->
      <link href="{{asset('frontend/endor/select2/css/select2.min.css')}}" rel="stylesheet">
                           ...
                           @if ($errors->any())
                                    ...
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="text-center pt-3">
                                            Don’t have an account? <a class="font-weight-bold" href="{{route('login')}}">Sign Up</a>
                                        </div>
                                    </form>
                           <hr class="my-4">
