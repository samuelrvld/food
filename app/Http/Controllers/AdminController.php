...
return redirect()->back()->with('error','Email Not Found');
    ...
    $message = "Please Clink on below link to reset password";
    $message .= "<a href ='".$reset_link."'> Click Here</a>";

    \Mail::to($request->email)->send(new Websitemail($subject,
    $message));
    return redirect()->back()->with('success', 'Reset Password Link Sen On your Email');
    }
    ...
    public function AdminProfileStore(Request $request){
        ...
        $data->save();
        $notification = array(
            'message' => 'Profile Updated Succes',
            'alert-type' => 'success'
        );
